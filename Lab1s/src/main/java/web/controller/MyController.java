...
public class MyController {
    ...
    public String method1(Model model) {
        model.addAttribute("message", "@/poly/url1 => method2()");
        return "page";
    }

    @RequestMapping("poly/url2")
    public String method2(Model model) {
        model.addAttribute("message", "@/poly/url2 => method3()");
        return "page";
    }

    @RequestMapping("/poly/url3")
    public String method3(Model model) {
        model.addAttribute("message", "@/poly/url3 => method4()");
        return "page";
    }

    @RequestMapping("/poly/url4")
    public String method4(Model model) {
        model.addAttribute("message", "@/poly/url4 => method5()");
        return "page";
    }
